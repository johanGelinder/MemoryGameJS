...
var finalCount = 0;
var sound = new Audio("sounds/win_sting2.wav"); // buffers automatically when created
var flipback = new Audio("sounds/flip2.wav");
var click = new Audio("sounds/flip.wav");
var win = new Audio("sounds/win_sting.wav");
 var music = new Audio("sounds/Yoshi.mp3");

$(music).bind('ended', function()  { // loops the background music
    music.currentTime = 0;
    music.play();
});
